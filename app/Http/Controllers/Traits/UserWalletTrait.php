...
trait UserWalletTrait
{
    ...
    public function addToWallet($user_id, $amount, $type, $description,$currency='₹')
    {
        Wallet::create([
            'user_id' => $user_id,
            'amount' => $amount,
    ...
    public function deductFromWallet($user_id, $amount, $type, $description,$currency='₹')
    {
    ...
    public function addWalletTransaction($user_id, $amount, $type, $description,$currency='₹')
    {
        DB::beginTransaction();
