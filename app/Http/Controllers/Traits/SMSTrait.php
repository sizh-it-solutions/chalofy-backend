...
trait SMSTrait
{
    public function sendSMS($subject, $message, $mobileNumber, $otp_for , $OTP )
    {
        ...
        switch ($smsProviderName) {
            ...
            case 'msg91':
                $this->sendViaMSG91($message, $mobileNumber, $otp_for , $OTP);
                break;
    ...
    private function sendViaMSG91_bkppp($message, $mobileNumber)
    {
    ...
    private function sendViaMSG91($message, $mobileNumber, $otp_for, $OTP)
    {
