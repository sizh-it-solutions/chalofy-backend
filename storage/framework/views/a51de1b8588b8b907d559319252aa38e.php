<script>
    ...
    success: function(response) {
        ...
        if (response.status === 403) {
            ...
            toastr.success(response.message || '<?php echo e(trans("global.data_has_been_submitted")); ?>', 'Success', {
                closeButton: true,
                progressBar: true,
                positionClass: "toast-bottom-right"
            });
...
<script>
    $(document).ready(function() {
        ...
        $('#autofillotp').change(function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('admin.update-auto-fill-otp')); ?>",
                        type: "POST",
                        data: {
                            status: status,
...
</script><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/generalSettings/smssettings/toastrmsg.blade.php ENDPATH**/ ?>