...
<div class="content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-horizontal" id="propertyFilterForm" action="<?php echo e(route($indexRoute)); ?>" method="GET"
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-12 col-xs-12">
                                ...
                                <select class="form-control select2" name="typeId" id="typeId">
                                    ...
                                    <option value="<?php echo e($type->id); ?>" <?php echo e(request('typeId')==$type->id ? 'selected' : ''); ?>
...
<script>
    ...
    $(function () {
        initializeFeatureDataTable({
            ...
            deleteUrl: "<?php echo e(route('admin.vehicle-makes.deleteAll')); ?>",
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/common/category/index.blade.php ENDPATH**/ ?>