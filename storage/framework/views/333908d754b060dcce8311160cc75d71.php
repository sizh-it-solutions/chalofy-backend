...
<section class="content">
  ...
  <h4 class="all_settings f-18 mt-1" style="margin-left:15px;">  <?php echo e(trans('global.manage_settings')); ?></h4>
    ...
    data-user-value="msg91"
  
    <?php echo e($sms_provider_name != "" && $sms_provider_name->meta_value == 'msg91' ? 'checked' : ''); ?>>
<label for="user<?php echo e($i); ?>" style="margin-left: 91%; margin-top: 8px;" class="checktoggle">checkbox</label>
         
            <form  method="post" action="<?php echo e(route('admin.msg91update')); ?>" class="form-horizontal smssettingform" enctype="multipart/form-data" novalidate="novalidate">
			<?php echo e(csrf_field()); ?>

              <div class="box-body">
             
              	<div class="form-group">
              		<label class="col-sm-3 control-label" for="inputEmail3"><?php echo e(trans('global.auth_key')); ?><span class="text-danger">*</span></label>
              		<div class="col-sm-6">
              			<input class="form-control" type="password" name="msg91_auth_key" id="sid" placeholder="key" value="<?php echo e($msg91_auth_key->meta_value ?? ''); ?>">
              		</div>
              	</div>
              	<div class="form-group">
              		<label class="col-sm-3 control-label" for="inputEmail3"><?php echo e(trans('global.template_id')); ?><span class="text-danger">*</span></label>
              		<div class="col-sm-6">
              			<input class="form-control" type="password" name="msg91_template_id" id="token" placeholder="secret" value="<?php echo e($msg91_template_id->meta_value ?? ''); ?>">
              		</div>
              	</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/generalSettings/smssettings/msg91.blade.php ENDPATH**/ ?>