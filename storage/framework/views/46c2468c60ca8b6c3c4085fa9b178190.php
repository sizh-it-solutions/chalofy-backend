        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="<?php echo e(route('admin.roles.create')); ?>">
                    <?php echo e(trans('global.add')); ?> <?php echo e(trans('global.role_title_singular')); ?>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo e(trans('global.role_title_singular')); ?> <?php echo e(trans('global.list')); ?>
                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Role">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?php echo e(trans('global.permission_title')); ?>
                                    ...
                                    <tr data-entry-id="<?php echo e($role->id); ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_edit')): ?>
                                                <a  style="margin-bottom:5px;margin-top:5px" class="btn btn-xs btn-info" href="<?php echo e(route('admin.roles.edit', $role->id)); ?>">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_delete')): ?>
                                                ...
                                                <?php echo csrf_field(); ?>
                                                <button type="button" class="btn btn-xs btn-danger delete-button" data-id="<?php echo e($role->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>