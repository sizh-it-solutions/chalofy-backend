                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.region')); ?> <span class="text-danger">*</span></label>
                                        <select name="place_id" data-saving="place_id" class="form-control f-14">
                                        <?php $__currentLoopData = $cityData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cityDataLoop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cityDataLoop->id); ?>" <?php echo e($itemData->place_id == $cityDataLoop->id ? 'selected' : ''); ?>> <?php echo e($cityDataLoop->city_name); ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.country')); ?> <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.address_line_1')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="address_line_1" class="okokok form-control" id="address_line_1" value="<?php echo e($itemData->address ?? ''); ?>" class="form-control f-14 pac-target-input" placeholder="House name/number + street/road" autocomplete="off">
                                        <span class="text-danger"></span>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.city_town_district')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="city" id="city"  value="<?php echo e($itemData->city_name ?? ''); ?>"  class="form-control f-14" placeholder="Apt., suite, building access code">
                                        <span class="text-danger" id="locationerror-city"></span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.state_province_country')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="state" id="state" class="stateget form-control"  value="<?php echo e($itemData->state_region ?? ''); ?>" class="form-control f-14">
                                        <span class="text-danger"></span>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb20">
                                        <label class="label-large fw-bold mt-4"><?php echo e(trans('global.zip_postal_code')); ?></label>
                                        <input type="text" name="postal_code" id="zipCode"  value="<?php echo e($itemData->zip_postal_code ?? ''); ?>" class="form-control f-14">
                                        <span class="text-danger"></span>
                                ...
                                <div class="row">
                                       <div class="col-6  col-lg-6  text-left">
                                            <a data-prevent-default="" href="<?php echo e(route($backButtonRoute,[$id])); ?>" class="btn btn-large btn-primary f-14"><?php echo e(trans('global.back')); ?></a>
                                        </div>
...
selectCountryByCode('<?php echo e($itemData->country); ?>');
...
<!-- map -->
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($api_google_map_key->meta_value ?? ''); ?>&libraries=places&callback=initMap"></script>
...
$(document).ready(function() {
    $('.text-white').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route($updateLocationRoute)); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/common/addSteps/location/location.blade.php ENDPATH**/ ?>