                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group <?php echo e($errors->has('front_image') ? 'has-error' : ''); ?>">
                                                <label for="front_image"><?php echo e(trans('global.front_image')); ?></label>
                                                <div class="needsclick dropzone" id="front_image-dropzone">
                                                </div>
                                                <?php if($errors->has('front_image')): ?>
                                                    <span class="help-block" role="alert"><?php echo e($errors->first('front_image')); ?></span>
                                                <?php endif; ?>
                                            
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group <?php echo e($errors->has('front_image_doc') ? 'has-error' : ''); ?>">
                                                <label for="front_image_doc">Document</label>
                                                <div class="needsclick dropzone" id="front_image_doc-dropzone">
                                                </div>
                                                <?php if($errors->has('front_image_doc')): ?>
                                                    <span class="help-block" role="alert"><?php echo e($errors->first('front_image_doc')); ?></span>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group <?php echo e($errors->has('gallery') ? 'has-error' : ''); ?>">
                                                <label for="gallery"><?php echo e(trans('global.gallery')); ?></label>
                                                <div class="needsclick dropzone" id="gallery-dropzone">
                                                </div>
                                                <?php if($errors->has('gallery')): ?>
                                                    <span class="help-block" role="alert"><?php echo e($errors->first('gallery')); ?></span>
                                                <?php endif; ?>
...
<script>
    ...
    $('.next').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route($updatePhoto)); ?>',
...
<script>
    ...
    url: '<?php echo e(route($storeMedia)); ?>',
    maxFilesize: 2, // MB
    ...
    init: function () {
<?php if(isset($itemData) && $itemData->front_image): ?>
      var file = <?php echo json_encode($itemData->front_image); ?>
...
Dropzone.options.galleryDropzone = {
    ...
    init: function () {
<?php if(isset($itemData) && $itemData->gallery): ?>
      var files = <?php echo json_encode($itemData->gallery); ?>
...
<script>
    ...
    init: function () {
<?php if(isset($itemData) && $itemData->front_image_doc): ?>
      var file = <?php echo json_encode($itemData->front_image_doc); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u946908376/domains/admin.chalofyrentals.in/public_html/resources/views/admin/common/addSteps/photo/photos.blade.php ENDPATH**/ ?>