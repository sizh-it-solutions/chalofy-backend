    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans('global.project_setup')}}</h3><span class="email_status" style="display: none;">(<span
            ...
            <div class="box box-info">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('global.project_cleanup')}}</h3><span class="email_status" style="display: none;">(<span
                            class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
                </div>
                ...
                <form id="fees_setting" method="post" action="#"
                    ...
                    <div class="box-body ">
                        ...
                        <div class="instruction-text" style="font-size: 13px">
                            ...
                            Please click the <strong>{{ trans('global.project_cleanup')}}</strong> button above to clear unnecessary data and improve system performance.
                        </div>
        ...
        <div class="row">
         <div class="col-md-9 col-md-offset-3">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fas fa-clock text-primary"></i> {{ trans('global.cron_job_settings')}}</h3><span
...
<script>
    $(document).ready(function($) {
        $('#setupButton').on('click', function(event) {
            ...
            $.ajax({
                url: "{{ route('admin.projectSetupAjax') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}"
                },
        ...
        $('#cleanupButton').on('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.projectCleanupAjax') }}",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
