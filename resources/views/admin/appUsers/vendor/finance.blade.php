                        ...
                        <div class="cardbg-1">
                            <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-3">
                                    <img class="sweicon" src="{{ asset('/images/icon/cash-new.png') }}"
                                        alt="transaction">
                                    <h2 class="cash--title text-white">{{ formatCurrency($hostspendmoney) }}  {{ $currency }}</h2>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="caredoane cardbg-2">
                                    <h4 class="title">{{ formatCurrency($hostpendingmoney) }} {{ $currency }}</h4>
                            ...
                            <div class="col-sm-6">
                                <div class="caredoane cardbg-3">
                                    <h4 class="title">{{ formatCurrency($hostrecivemoney) }}  {{ $currency }}</h4>
                            ...
                            <div class="col-sm-6 mt-3">
                                <div class="caredoane cardbg-6 bg-danger">
                                    <h4 class="title">{{ formatCurrency($refunded) }}  {{ $currency }}</h4>
                                    <div class="subtitle">{{ trans('global.totalRefund') }}</div>
                                    <img class="sweicon" src="{{ asset('/images/icon/earning.png') }}"
                                        alt="transaction">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default shadow-sm">
                    <div class="panel-heading bg-primary text-white p-3">
                        <h4 class="panel-title m-0">{{ trans('user.vendor_wallet_transaction') }}</h4>
                    </div>
                                ...
                                <tbody>
                                    @forelse ($vendor_wallets as $vendor_wallet)
                                        <tr class="{{ $vendor_wallet->type === 'credit' ? 'table-success' : 'table-warning' }}">
                                            ...
                                            <td class="text-right">
                                                @if($vendor_wallet->type === 'credit')
                                                    <strong>{{  formatCurrency($vendor_wallet->amount)." ".$currency }}</strong>
                                                @endif
                                            </td>
