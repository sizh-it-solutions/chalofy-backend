...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/user-profile.css') }}" media="screen">
@endsection
@section('content')
    <div class="container-fluid content">
        ...
        <div class="driver-profile-page">
            <div class="profile-container">
                ...
                <div class="row g-3">
                    <form method="POST"
                        action="{{ route('admin.app-users.update', [$appUser->id]) }}?from_overviewprofile=true"
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 {{ $errors->has('first_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="first_name" id="first_name"
                                    value="{{ old('first_name', $appUser->first_name) }}" required>
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('middle') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="middle" id="middle"
                                    value="{{ old('middle', $appUser->middle) }}">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('last_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="last_name" id="last_name"
                                    value="{{ old('last_name', $appUser->last_name) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="phone" id="phone"
                                    value="{{ old('phone', $appUser->phone) }}" required>
...
@section('scripts')
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key={{ $api_google_map_key->meta_value ?? '' }}&libraries=places&callback=initAutocomplete"></script>
