...
<script>
    $(document).ready(function() {
        ...
        var selectedUserId = "{{ $searchfieldId }}"; // Get user ID from the controller
        var selectedUserName = "{{ $searchfield }}"; // Get user name from the controller
...
<script>
    $(document).ready(function() {
        ...
        var selectedUserId = "{{ $searchCustomerId }}"; // Get user ID from the controller
        var selectedUserName = "{{ $searchCustomer }}"; // Get user name from the controller

        if (selectedUserId) {
            var option = new Option(selectedUserName, selectedUserId, true, true);
            $('#customer1').append(option).trigger('change');
        }
    });
</script>
<script>
    $(document).ready(function() {
        ...
        var selectedUserId = "{{ $searchfieldItemId }}"; // Get user ID from the controller
        var selectedUserName = "{{ $searchfieldItem }}"; // Get user name from the controller
