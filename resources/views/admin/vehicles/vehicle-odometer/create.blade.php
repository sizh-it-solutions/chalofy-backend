        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('global.vehicle_odometer') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicle-odometer.store") }}" enctype="multipart/form-data">
                        @csrf
                      <input type="hidden" name="module" value="{{$moduleId}}">
                        <div class="form-group {{ $errors->has('model_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="model_name" value="{{ old('model_name', '') }}" required>
