        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('global.addCoupon_title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.add-coupons.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('coupon_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="coupon_title" id="coupon_title" value="{{ old('coupon_title', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('coupon_expiry_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="date" name="coupon_expiry_date" id="coupon_expiry_date" value="{{ old('coupon_expiry_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('min_order_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('coupon_value') ? 'has-error' : '' }}">
                          ...
                          <input class="form-control" type="number" name="coupon_value" id="coupon_value" value="{{ old('coupon_value', '') }}" step="0.01" required>
                              <select class="form-control mr-2" name="coupon_type" id="coupon_type" required>
                                  <option value="percentage" {{ old('coupon_type') == 'percentage' ? 'selected' : '' }} selected>Percentage</option>
                              </select>
